...
public class JoueurIA implements IJoueur {
  ...
  public String choixMouvement() {
    ...
    else if (nbCases > TOTAL_CASES/4) {
      // MiniMax
      move = this.mMiniMax.findTheBestMove(copyPlateau(this.mPlateau));
    }
    else {
      // AlphaBeta
    	move = this.mAlphaBeta.findTheBestMove(copyPlateau(this.mPlateau));
    }
